...
insert  into `detail_jawaban`(`detailjawaban_id`,`detailjawaban_score_id`,`detailjawaban_soal_id`,`detailjawaban_jawaban`) values (3,20,2,'d'),(4,20,3,'b'),(5,21,2,'a'),(6,21,3,'d'),(7,22,2,'c'),(8,22,3,'c'),(9,23,2,'a'),(10,23,3,'d'),(13,24,2,'d'),(14,24,3,'');
...
insert  into `score`(`score_id`,`score_nim`,`score_mapel_id`,`score_score`,`score_answer_false`,`score_answer_true`,`score_answer_empty`) values (1,'123',2,8,NULL,NULL,NULL),(20,'1234',2,100,NULL,NULL,NULL),(23,'1234',2,50,1,1,0),(22,'1234',2,0,NULL,NULL,NULL),(21,'1234',2,50,NULL,NULL,NULL),(24,'123',2,50,0,1,0);
