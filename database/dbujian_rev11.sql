...
insert  into `detail_jawaban`(`detailjawaban_id`,`detailjawaban_score_id`,`detailjawaban_soal_id`,`detailjawaban_jawaban`) values (21,27,11,'c'),(22,27,10,'a');
...
insert  into `mapel`(`mapel_id`,`mapel_name`,`mapel_pass_score`,`mapel_duration`,`mapel_desc`) values (6,'Bahasa Indonesia',70,90,'Bahasa Indonesia'),(7,'Bahasa Inggris',75,90,'Bahasa Inggris'),(8,'Agama',80,90,'Agama');
...
insert  into `score`(`score_id`,`score_user_id`,`score_mapel_id`,`score_score`,`score_answer_false`,`score_answer_true`,`score_answer_empty`) values (27,'86',1,100,0,2,0);
