...
<html>
<head>
<title>::Soal Analisa Ujian Test::.</title>
...
?>
<form action=nilaianalisa.php method=post id="form-area" onSubmit="return validasi_input(this)">
<ol>
  <?php
		$hasil=mysql_query("select * from tsoal LIMIT 30");
