...
<html>
<head>
<title>::Soal Inggris Ujian Test::.</title>
...
?>
<form action=nilaiinggris.php method=post id="form-area" onSubmit="return validasi_input(this)">
<ol>
  <?php
		$hasil=mysql_query("select * from tsoal2 LIMIT 30");
